...
COLLAPSED_BAR_BG = "#2e2e2e"
COLLAPSED_BAR_BORDER = "#444444"
COLLAPSED_TEXT_COLOR = "#a0a0a0"
TOOLBAR_BG = "#333333"
TOOLBAR_FG = "#c0c0c0"
TOOLBAR_BTN_FG = "#d0d0d0"
SIDEBAR_HEADER_BG = "#2a2a2a"
SIDEBAR_HEADER_FG = "#909090"
...
class GuichiShell:
    ...
    def _build_panes(self):
        ...
        self._left_panel = tk.Frame(self._main_frame, width=SIDEBAR_OPEN_W)
        ...
        self._left_content = tk.Frame(self._left_panel)
        ...
        sidebar_frame = tk.Frame(self._left_content)
        ...
        self._right_panel = tk.Frame(self._main_frame, width=RIGHT_COLLAPSED_W)
        ...
        self._right_content = tk.Frame(self._right_panel)
        ...
        self._right_sw_area = tk.Frame(self._right_content)
    ...
    def _apply_layout(self):
        ...
        if self.toolbar_full:
            # Full width: toolbar fills the wrapper
    ...
    def _on_sidebar_select(self, event=None):
        ...
        if kind == "pack":
            ...
            self._show_page_info(parsed[1], parsed[2])
        elif kind == "dev_item":
    ...
    def _render_detail_text(self, parent, text):
        ...
        detail_widget = tk.Text(parent, height=10, wrap=tk.WORD, font=INFO_VALUE_FONT)
        detail_widget.insert(tk.END, text)
        detail_widget.configure(state=tk.DISABLED)
        detail_widget.pack(fill=tk.BOTH, expand=True, pady=(2, 0))
